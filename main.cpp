...
int main(){
    ...
    fib_seq(user_input1);
    std::cout << std::endl << "Term in sequence" << std::endl;
    fib_term(user_input1);
    std::cout << std::endl << "Friendly sequences" << std::endl;
    friendly(user_input1);
    std::cout << std::endl << "Number of sequences" << std::endl;
    ...
    std::cout << std::endl << "Flips your number, identifies if it is a palindrome" << std::endl;
    palindrome(user_input1);
    std::cout << std::endl << "If the number is prime" << std::endl;
    prime(user_input1);
